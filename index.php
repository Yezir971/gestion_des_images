...
if(isset($_GET["delete_image"])){//la super global GET contient l'id des images stocker dans la base de donneés
    delete($_GET["delete_image"]);//grace à la super global GET lorsque l'on va clicker sur le lien hyper texte supprimer d'une image on va récupérer son id dans le l'url de l'image
}
